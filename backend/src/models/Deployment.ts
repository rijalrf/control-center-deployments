...
import { DeploymentAttributes } from '../types';

export class Deployment extends Model<DeploymentAttributes, Omit<DeploymentAttributes, 'id'>> implements DeploymentAttributes {
  public id!: number;
