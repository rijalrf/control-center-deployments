...
import { DeploymentStepAttributes } from '../types';

export class DeploymentStep extends Model<DeploymentStepAttributes, Omit<DeploymentStepAttributes, 'id'>> implements DeploymentStepAttributes {
  public id!: number;
